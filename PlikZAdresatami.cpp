...
void PlikZAdresatami::podajIUstawIdOstatniegoAdresataPoUsunieciuWybranegoAdresata(int idUsunietegoAdresata)
...
void PlikZAdresatami::usunWybranegoAdresataZPliku(int idAdresata)
{
    ...
    if (odczytywanyPlikTekstowy.good() == true)
    {
        while (getline(odczytywanyPlikTekstowy, daneJednegoAdresataOddzielonePionowymiKreskami))
        {
           ...
           {
               if (idAdresata != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami) && idOstatniegoAdresata!=pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami))
               {
                   tymczasowyPlikTekstowy <<daneJednegoAdresataOddzielonePionowymiKreskami<<endl;
               }
                else if (idAdresata != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami) && idOstatniegoAdresata==pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami))
               {
...
void PlikZAdresatami::edycjaDanychWybranegoAdresata(Adresat adresat)
{
    fstream odczytywanyPlikTekstowy, tymczasowyPlikTekstowy;
    string daneJednegoAdresataOddzielonePionowymiKreskami = "";
    ...
    if (odczytywanyPlikTekstowy.good() == true)
    {
        while (getline(odczytywanyPlikTekstowy, daneJednegoAdresataOddzielonePionowymiKreskami))
        {
            if (idEdytowanegoAdresata!=idOstatniegoAdresata)
           {
               if (idEdytowanegoAdresata != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami) && idOstatniegoAdresata!=pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami))
               {
                   tymczasowyPlikTekstowy <<daneJednegoAdresataOddzielonePionowymiKreskami<<endl;
               }
                else if (idEdytowanegoAdresata  != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami) && idOstatniegoAdresata==pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami))
               {
                   tymczasowyPlikTekstowy <<daneJednegoAdresataOddzielonePionowymiKreskami;
               }
